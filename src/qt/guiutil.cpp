...
{
    if(uri.scheme() != QString("growthcoin"))
        return false;
...
{
    // Convert growthcoin:// to growthcoin:
    //
    //    Cannot handle this later, because growthcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("growthcoin://"))
    {
        uri.replace(0, 11, "growthcoin:");
    }
